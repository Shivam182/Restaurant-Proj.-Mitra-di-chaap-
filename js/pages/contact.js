...
function getUserDetails(usrUrl){
    ...
    httpReq1.setRequestHeader('Authorization','Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJyYWh1bEBnbWFpbC5jb20iLCJleHAiOjE2ODE0NzgxNjUsImlhdCI6MTY4MTQ3NjM2NX0.wLgwuu76FKgJmFvo6xP-_iExbNJLyetWbf3c2a_3udsfeWwdBhGal6VFKZyzCYpIISFMcO7AYiwpjyEFaBzBNg')
...
function showSuccessAlert(){
    ...
    if(httpReq.readyState === XMLHttpRequest.DONE && httpReq.status === 200){
        ...
        feedbacks.value = '';
        alert('Your Feedback has been recorded successfully. We will get in touch with you soon.');
